...
template<> class numeric_limits<::doi::f16> {
public:
	static const bool is_specialized = true;
	static doi::f16 min () { return doi::f16(0, 1, 0); }
	static doi::f16 max () { return doi::f16(0, 30, 0xFFFFu); }
	...
	static doi::f16 epsilon () { return 0.0009765625f; } // 2^-10
	static doi::f16 round_error () { return 0.00048828125; } // 2^-11
	...
	static doi::f16 denorm_min() { return doi::f16(1, 0, 1); }
	static doi::f16 infinity() { return doi::f16(0, 31, 0); }
	static doi::f16 quiet_NaN() { return doi::f16(0, 31, 1); }
	static doi::f16 signaling_NaN() { return doi::f16(0, 31, 1); }
};

template<> struct is_floating_point<::doi::f16> : std::true_type {};
