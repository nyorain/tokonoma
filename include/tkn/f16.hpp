...
template<> class numeric_limits<::tkn::f16> {
public:
	static const bool is_specialized = true;
	static tkn::f16 min () { return tkn::f16(0, 1, 0); }
	static tkn::f16 max () { return tkn::f16(0, 30, 0xFFFFu); }
	...
	static tkn::f16 epsilon () { return 0.0009765625f; } // 2^-10
	static tkn::f16 round_error () { return 0.00048828125; } // 2^-11
	...
	static tkn::f16 denorm_min() { return tkn::f16(1, 0, 1); }
	static tkn::f16 infinity() { return tkn::f16(0, 31, 0); }
	static tkn::f16 quiet_NaN() { return tkn::f16(0, 31, 1); }
	static tkn::f16 signaling_NaN() { return tkn::f16(0, 31, 1); }
};

template<> struct is_floating_point<::tkn::f16> : std::true_type {};
